...
print(arr10)
arr10 = math.random.ranf()
print("in random ranf, it gives values between 0 and 1 and all are random values will float but it can be positive or negative")
print(arr10)
arr10 = math.random.randint(5,10,size=(2,2))
print("in random randint, start point is compulsory but size and end is optional")
print(arr10)