...
print("\n\nWe will check item size of array by using item size")
onedarr = np.array([1,2,3],dtype="complex")
print("item size of 1d array: ",onedarr," : ",onedarr.dtype," : ",onedarr.itemsize)
twodarr = np.array((([1,2,3],[4,5,6],[8,7,9])),dtype="float")
print("item size of 2d array: ",twodarr," : ",twodarr.dtype," : ",twodarr.itemsize)
threedarr = np.array((([1,3,5,7,8],[4,6,9,10,2]),([1,2,3,4,8],[3,0,11,7,4])),dtype="int")
print("item size of 3d array: ",threedarr," : ",threedarr.dtype," : ",threedarr.itemsize)