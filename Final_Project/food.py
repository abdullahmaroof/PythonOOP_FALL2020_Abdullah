...
pizza_btn = Button(pframe_right,  text="Pizza", width=20, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
burger_frame = Frame(bottom_center, bg="white", height=60)
bframe_left = Frame(burger_frame, bg="white", height=60)
burger = Image.open("pizza.PNG")
...
biryani_btn = Button(biframe_right,  text="Biryani", width=20, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
paratharoll_frame = Frame(bottom_center, bg="white", height=60)
paframe_left = Frame(paratharoll_frame, bg="white", height=60)
paratharoll = Image.open("pizza.PNG")
...
paratha_btn = Button(paframe_right,  text="Paratha Roll", width=20, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
