...
def call_burgermenu():
    ...
    zbprice_btn = Button(zbprice_frame,  text="400 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    zbcold_frame = Frame(zb_frame, bg="white", height=30)
    zbcold_btn = Button(zbcold_frame,  text="500 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    zbcoldf_frame = Frame(zb_frame, bg="white", height=30)
    zbcoldf_btn = Button(zbcoldf_frame,  text="600 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    ...
    bbprice_btn = Button(bbprice_frame,  text="500 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    bbcold_frame = Frame(bb_frame, bg="white", height=30)
    bbcold_btn = Button(bbcold_frame,  text="600 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    bbcoldf_frame = Frame(bb_frame, bg="white", height=30)
    bbcoldf_btn = Button(bbcoldf_frame,  text="700 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    ...
    cbprice_btn = Button(cbprice_frame,  text="450 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    cbcold_frame = Frame(cb_frame, bg="white", height=30)
    cbcold_btn = Button(cbcold_frame,  text="550 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    cbcoldf_frame = Frame(cb_frame, bg="white", height=30)
    cbcoldf_btn = Button(cbcoldf_frame,  text="650 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    ...
    sbprice_btn = Button(sbprice_frame,  text="350 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    sbcold_frame = Frame(sb_frame, bg="white", height=30)
    sbcold_btn = Button(sbcold_frame,  text="450 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    sbcoldf_frame = Frame(sb_frame, bg="white", height=30)
    sbcoldf_btn = Button(sbcoldf_frame,  text="550 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    ...
    bbbprice_btn = Button(bbbprice_frame,  text="500 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    bbbcold_frame = Frame(bbb_frame, bg="white", height=30)
    bbbcold_btn = Button(bbbcold_frame,  text="600 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
    bbbcoldf_frame = Frame(bbb_frame, bg="white", height=30)
    bbbcoldf_btn = Button(bbbcoldf_frame,  text="700 RS", width=15, bg="light blue", font=('arial',10,'bold'), activebackground="black", activeforeground="white")
